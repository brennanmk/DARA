...
def augments():
    if request.method == 'POST':
        if 'delete' in request.form:
            ...
            controller.update_augment_table(request.form["update"], request.form["rob_id"], request.form["name"], request.form["location"], request.form["config"])
        elif 'create' in request.form:
            controller.add_augment(request.form["rob_id"], request.form["name"], request.form["location"], request.form["config"])
